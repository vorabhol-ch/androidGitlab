...
public class DetailActivity extends LifecycleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date date = new Date(timestamp);
         ...
         //create the ViewModelProviders.of it's create a viewmodel instance
        ...
        AppExecutors.getInstance().diskIO().execute(()->{
            try{
                ...
                WeatherEntry pretendWeatherFromDatabase = new WeatherEntry(1,210,today,88.00,99.00,71,1030,74,5);
